...
namespace StarterM.Controllers
{
    public class OperasController : Controller
    {
        ...
        {
              return _context.Operas != null ? 
                          View(await _context.Operas.ToListAsync()) :
                          Problem("Entity set 'OperaContext.Opera'  is null.");
        }
        ...
        {
          return (_context.Operas?.Any(e => e.OperaID == id)).GetValueOrDefault();
        }
    }
}
